...
public class deathCertificate{
	...
	public void question() {
        ...
        //Maternal Condition
           ...
           System.out.println("\t\t\t\t\t[b] Pregnant, in labour");
           ...
           if(maternalCondition.equalsIgnoreCase("a")){
               maternalCondition = "\t\t\t\t\tPregnant, not labour";
               System.out.println("\t\t\t\t\tPregnant, not labour");
           }else if(maternalCondition.equalsIgnoreCase("b")){
            maternalCondition = "\t\t\t\t\tPregnat, in labour";
               System.out.println("\t\t\t\t\tPregnant, in labour");
